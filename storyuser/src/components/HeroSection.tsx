...
export function HeroSection({ content, onShopEdit, onViewLookbook }: HeroSectionProps) {
  return (
    <section
      className="relative mx-auto max-w-[1280px] px-5 sm:px-6 lg:px-8"
      id="editorial-hero"
    >
      ...
      {/* Desktop: Text + Image grid */}
      <div className="hidden lg:flex lg:items-center" style={{ minHeight: 'min(560px, calc(100vh - 180px))' }}>
        <div className="grid w-full grid-cols-[0.45fr_0.55fr] items-center gap-12">
          {/* Left: content */}
